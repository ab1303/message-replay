...
namespace MessageReplay.Api.Common.Helpers
{
    public class ServiceBusPurger
    {
        ...
        public ServiceBusPurger(ServiceBusHelper serviceBusHelper, QueueProperties queueProperties)
        {
            this.serviceBusHelper = serviceBusHelper;
            this.queueProperties = queueProperties;
        }

        public ServiceBusPurger(ServiceBusHelper serviceBusHelper, SubscriptionProperties subscriptionProperties)
        {
            this.serviceBusHelper = serviceBusHelper;
        ...
        async Task<long> PurgeSessionEntity()
        {
            ...
            var client = ServiceBusClientSingleton.Instance.Client;
        ...
        {
            var client = ServiceBusAdministrationClientSingleton.Instance.Client;
